...
function VFCNavigation(props) {
  ...
  const drawer = (
    <div>
      ...
      <Divider />
      <List>
      <Link to="/VerificationDashboard" className={classes.link}>
              <ListItem button>
                <ListItemIcon>
                  <HomeIcon />
                </ListItemIcon>
            ...
            <Link to="/VerifierRegistration" className={classes.link}>
              <ListItem button>
                <ListItemIcon>
                  <AssignmentIndIcon />
                </ListItemIcon>
                <ListItemText primary={"Verifier Registration"} />
              </ListItem>
            </Link>
      </List>
      <Divider />
      ...
      <Link to="/VerifierRecordVfc" className={classes.link}>
              <ListItem button>
                <ListItemIcon>
                  <AssignmentIndIcon />
                </ListItemIcon>
                <ListItemText primary={"Verifier Record"} />
              </ListItem>
            </Link>
      </List>
