...
function DoctorNavigation(props) {
  const { window } = props;
  ...
  const drawer = (
    <div>
      ...
      <Divider />
      <List>
      <Link to="/DoctorDashboard" className={classes.link}>
              <ListItem button>
                <ListItemIcon>
                  <HomeIcon />
                </ListItemIcon>
      ...
      <Link to="/VaccinationRecordDoc" className={classes.link}>
              <ListItem button>
                <ListItemIcon>
                  <AssignmentIndIcon />
                </ListItemIcon>
                <ListItemText primary={"Vaccination Record"} />
              </ListItem>
            </Link>
      </List>
